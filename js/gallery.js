...
const createGalleryCard = (imageInfo) => {
  return `<li class="gallery-item"> <a class="gallery-link" href="${imageInfo.original}">
    <img class="gallery-image" src="${imageInfo.preview}"  data-source="${imageInfo.original}" alt="${imageInfo.description}" width="360" height="200" />  </a>
  </li>`;
};
